...
global.sig = 'https://instagram.com/neyzardwinansyh' //Link Instagrammu
global.sgh = 'https://github.com/Neyzz21' //Link Githubmu
global.sgc = 'https://chat.whatsapp.com/JygulzqR0LEA5Y7wlCS1jp'
global.sdc = '_'
global.stg = 'https://instagram.com/neyzardwinansyh'
global.syt = '-' //Isi Pake Link Discordmu Kalo Gada Biarin aja
global.snh = 'ZAR-BOTZ🗿' //Hmmm, Ini boleh kalian isi terserah :v

/*============== PAYMENT ==============*/
global.pdana = '087746053136' //Nomor Danamu
global.ppulsa = '085875063235' //Nomor SimCard Yang Kamu Pake
global.psaweria = '-' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '6287746053136' //Nomor Bot
global.nomorown = '6285875063235' //Nomor Owner
global.namebot = 'ZAR-BOTZ'  //Nama Bot
global.nameown =  'Neyzz' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6285875063235', '❦ Neyzz 🎐', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 Zar-Bot 汉  」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Zar-Botz˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺  ZAR-BOTZ'
...
global.packname2 = 'ᴄʀᴇᴀᴛᴇᴅ ʙʏ Neyzz'
